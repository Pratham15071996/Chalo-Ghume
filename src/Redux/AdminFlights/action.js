...
export const addFlight = (payload) => (dispatch) => {
  ...
  axios
    .post("https://happy-sunglasses-eel.cyclic.app/flight", payload) // https://makemytrip-api-data.onrender.com/flight
    .then(() => {
...
export const fetchFlightProducts = (limit) => (dispatch) => {
  dispatch(flightRequest());
  axios
    .get(`https://happy-sunglasses-eel.cyclic.app/flight?_limit=${limit}`)   //https://makemytrip-api-data.onrender.com/flight?_limit=${limit}
    .then((res) => {
...
export const DeleteFlightProducts = (deleteId) => async (dispatch) => {
  try {
    const res = await axios(
      `https://happy-sunglasses-eel.cyclic.app/flight?${deleteId}`, //https://makemytrip-api-data.onrender.com/flight/${deleteId}
      {
        method: "DELETE",
        headers: {

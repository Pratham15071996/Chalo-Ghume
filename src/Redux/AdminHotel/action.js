...
export const addHotel = (payload) => (dispatch) => {
  ...
  axios
    .post("https://happy-sunglasses-eel.cyclic.app/hotel", payload) // https://makemytrip-api-data.onrender.com/hotel
    .then(() => {
...
export const fetchingHotels = (limit) => (dispatch) => {
  axios
    .get(`https://happy-sunglasses-eel.cyclic.app/hotel?_limit=${limit}`) // https://makemytrip-api-data.onrender.com/hotel?_limit=${limit}
    .then((res) => {
...
export const DeleteHotel = (deleteId) => async (dispatch) => {
  try {
    const res = await fetch(
      `https://happy-sunglasses-eel.cyclic.app/hotel/${deleteId}`, // https://makemytrip-api-data.onrender.com/hotel/${deleteId}
      {
        method: "DELETE",
        headers: {

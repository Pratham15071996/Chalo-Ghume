...
export const AdminDashboard = () => {
 ...
 const [loading, setLoading] = useState(false);
  ...
  const getHotel = () => {
    ...
    //
    axios
      .get("https://happy-sunglasses-eel.cyclic.app/hotel")
      .then((res) => {
    ...
    axios
      ...
      axios
      .get("https://happy-sunglasses-eel.cyclic.app/giftcards")
      .then((res) => {
      ...
      axios
      .get("https://happy-sunglasses-eel.cyclic.app/Things_todo")
      .then((res) => {

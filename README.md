<h1>Chalo Ghume - Travel Booking Web Application</h1>

<p>This project is developed by Pratham Sinha. The purpose of this project is to showcase my skill and knowledge in HTML, CSS, JavaScript, React, Redux, and Json-Server.<p>
